...
<div class="comment_section">
  ...
  <div class="comment_form">
    ...
    <form class="" action="" method="post">
      <div>
          <?php if(isset($errors) && in_array(Comment::AUTHOR_INVALID, $errors)) echo "auteur invalide"; ?>
          <label for="name">Votre nom</label>
          <input type="text" name="author" id="name" value="" placeholder="votre nom">
        </div>
        <div>
          <?php if(isset($errors) && in_array(Comment::CONTENT_INVALID, $errors)) echo "commentaire invalide"; ?>
...
<div class="comment_list">
  <?php if($commentManager->getListChecked($post->id())) : ?>
    <?php foreach($commentManager->getListChecked($post->id()) as $comment) : ?>
      <div class="comment">
